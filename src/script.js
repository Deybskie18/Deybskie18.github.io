...
const boxHeight = 5;  // The uniform height of each box layer
...
function init() {
    ...
    function addTexturedSphere() { 
        ...
        moonSphere.position.set(-20, 7, -15); // Adjust distance and position relative to Earth
        // Add Moon to the scene
        scene.add(moonSphere);

        // Create Mars sphere geometry
        const marsGeometry = new THREE.SphereGeometry(8, 32, 32); // Mars is smaller
        // Load Mars texture
        ...
        marsSphere.position.set(-35, 9, -40);
...
*/
    ...
    camera.position.set(5, 5, 5);  // Position the camera above and to the side
